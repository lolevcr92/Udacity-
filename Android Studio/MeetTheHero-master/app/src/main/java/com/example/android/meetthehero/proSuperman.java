...
public class proSuperman extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.pro_superman );
...
//        Setting up finish button
        finish = (Button) findViewById( R.id.finish_button_superman );
...
//    Finish button method
    protected void finishClicked(){
        questionSevenGroup = (ToggleButtonGroupTableLayout) findViewById( R.id.Question7_group_superman );
        questionEightGroup = (ToggleButtonGroupTableLayout) findViewById( R.id.Question8_group_superman );
        ...
        RadioButton correctAnswerQuestion7 = (RadioButton) findViewById( R.id.answer_Jonathan_Marta );
        RadioButton correctAnswerQuestion8 = (RadioButton) findViewById( R.id.answer_hope );
        ...
        Log.i("Superman result: ", stringScorePro);
