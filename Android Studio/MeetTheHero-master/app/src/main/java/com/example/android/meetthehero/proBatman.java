...
public class proBatman extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.pro_batman );
...
//        Setting up finish button
        finish = (Button) findViewById( R.id.finish_button_batman );
...
//    Finish button method
    protected void finishClicked(){
        questionSevenGroup = (ToggleButtonGroupTableLayout) findViewById( R.id.Question7_group_batman );
        questionEightGroup = (ToggleButtonGroupTableLayout) findViewById( R.id.Question8_group_batman );
        ...
        RadioButton correctAnswerQuestion7 = (RadioButton) findViewById( R.id.answer_butler );
        RadioButton correctAnswerQuestion8 = (RadioButton) findViewById( R.id.answer_25 );
        ...
        Log.i("Batman result: ", stringScorePro);
