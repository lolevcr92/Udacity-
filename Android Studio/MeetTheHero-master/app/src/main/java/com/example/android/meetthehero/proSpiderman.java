...
public class proSpiderman extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.pro_spiderman );
...
//        Setting up finish button
        finish = (Button) findViewById( R.id.finish_button_spiderman );
...
//    Finish button method
    protected void finishClicked(){
        questionSevenGroup = (ToggleButtonGroupTableLayout) findViewById( R.id.Question7_group_spiderman );
        questionEightGroup = (ToggleButtonGroupTableLayout) findViewById( R.id.Question8_group_spider );
        ...
        RadioButton correctAnswerQuestion7 = (RadioButton) findViewById( R.id.answer_unknown );
        RadioButton correctAnswerQuestion8 = (RadioButton) findViewById( R.id.answer_shot );
        ...
        Log.i("Spider-Man result: ", stringScorePro);
